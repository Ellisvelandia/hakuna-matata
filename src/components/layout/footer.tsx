      ...
      <div className="border-t border-gray-200 py-4">
        <div className="container mx-auto flex justify-center space-x-4">
          <a
            ...
            aria-label="Facebook"
            className="w-10 h-10 rounded-full bg-[#ff9800] flex items-center justify-center text-white hover:opacity-80"
          >
            <svg
              ...
              <div className="md:hidden">
                <div className="mb-4">
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>
                      <Link href="/sin-miedo" className="hover:text-primary">
                        Sin Miedo
                      </Link>
                    </li>
                  </ul>
                ...
                <div className="mb-4">
                  ...
                  <ul className="space-y-1">
                    <li>
                      <Link href="/bienestar" className="hover:text-primary">
                        Bienestar
                      </Link>
                    </li>
                    <li>
                      <Link href="/vacunas" className="hover:text-primary">
                        Vacunas
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/cirugia" className="hover:text-primary">
                        Cirugía
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/acupuntura" className="hover:text-primary">
                        Acupuntura
                      </Link>
                    </li>
                    <li>
                    ...
                    <li>
                      <Link href="/peluqueria" className="hover:text-primary">
                        Peluquería
                      </Link>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <ul className="space-y-1">
                    ...
                    <li>
                      <Link
                        href="/registros-mascota"
                        className="hover:text-primary"
                      >
                        Registros de Mascota
                      </Link>
                    </li>
                  </ul>
                </div>
