    ...
    <PageLayout title="Acerca de Nosotros">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div>
          ...
          <h2 className="text-3xl font-semibold mb-6 text-[#8cb9a3]">Nuestra Misión</h2>
          <p className="mb-8 text-gray-700">
          ...
          <h2 className="text-3xl font-semibold mb-6 text-[#8cb9a3]">Nuestros Valores</h2>
        ...
        <div>
          ...
          <div className="bg-[#f0f7f4] rounded-lg p-6 mb-8">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/nuestro-equipo" className="flex items-center text-[#8cb9a3] hover:text-[#7aa08a]">
              ...
              <li>
                <Link href="/amigable-con-gatos" className="flex items-center text-[#8cb9a3] hover:text-[#7aa08a]">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <Link href="/sin-miedo" className="flex items-center text-[#8cb9a3] hover:text-[#7aa08a]">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
              ...
              <li>
                <Link href="/galeria-fotos" className="flex items-center text-[#8cb9a3] hover:text-[#7aa08a]">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <ul className="space-y-3 text-gray-700">
              <li className="flex items-start">
                <svg className="w-5 h-5 text-[#8cb9a3] mt-1 mr-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
